...
import { ArrowRight, XCircle, CheckCircle, Activity, AlertTriangle, Zap, LucideIcon, X } from 'lucide-react';
      ...
      >
        ...
        <div className="relative bg-white border-2 sm:border-4 border-black p-0 flex flex-col h-full min-h-[450px] sm:min-h-[500px]">
          ...
          <div className="flex-1 p-4 sm:p-6 md:p-8 flex items-center justify-center bg-white relative overflow-hidden">
               ...
               <div 
                 className="relative w-full aspect-square border-2 border-dashed border-black/20 p-3 sm:p-4 group-hover:border-black/50 transition-colors cursor-pointer"
                 onClick={openModal}
               >
        ...
        {isModalOpen && (
          ...
          >
            <motion.div
              ...
              className="relative max-w-4xl max-h-[90vh] bg-white border-4 border-black shadow-2xl"
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 border-b-4 border-black bg-gray-50">
                ...
                <button
                  onClick={closeModal}
                  className="p-1 hover:bg-black hover:text-white transition-colors duration-200 border-2 border-transparent hover:border-black"
                >
              ...
              <div className="p-6 bg-white">
                <img
                  src={image}
                  alt={title}
                  className="w-full h-auto max-h-[70vh] object-contain border-2 border-black"
                />
              </div>

              <div className="p-4 border-t-4 border-black bg-gray-50">
                <div className="flex items-center justify-between">
                  <div className="font-mono text-xs font-bold text-gray-600 uppercase">
                    {subtitle}
                  </div>
